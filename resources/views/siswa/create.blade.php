        ...
        <div class="card mt-3 p-3">
            <form action="/siswa" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="date" name="tgl_lahir_siswa" class="form-control @error('tgl_lahir_siswa') is-invalid @enderror" value="{{ old('tgl_lahir_siswa') }}">
                ...
                <div class="form-group">
                    ...
                    <textarea name="alamat_siswa" class="form-control @error('alamat_siswa') is-invalid @enderror" cols="20" rows="3"></textarea>
                    @error('alamat_siswa')
                    <div class="text-danger">
                        {{ $message }}
                    </div>
